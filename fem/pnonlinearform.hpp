...
/// Parallel non-linear operator on the true dofs
class ParTimeDepNonlinearForm : public TimeDepNonlinearForm
{
protected:
   mutable ParGridFunction X, Y;
   mutable OperatorHandle pGrad;
...
public:
   ParTimeDepNonlinearForm(ParFiniteElementSpace *pf);
   ...
   virtual ~ParTimeDepNonlinearForm() { }
};
...
public:
   ...
   /// Destructor.
   virtual ~ParBlockTimeDepNonlinearForm();
};
